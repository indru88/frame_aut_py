...
class Funciones_Globales():
    ...
    def mouse_drag_and_drop(self,xpath_o, xpath_d):
        element_o = self.find(xpath_o)
        element_d = self.find(xpath_d)
        self.scroll(xpath_o)
        act = ActionChains(self.driver)
        act.drag_and_drop(element_o, element_d).perform()
        self.dormir()

    def mouse_drag_and_dropXY(self,xpath, x, y):
    ...
    def mouse_xy(self, xpath, x, y):
        element = self.find(xpath)
        # self.scroll(xpath)
        act = ActionChains(self.driver)
        act.move_to_element_with_offset(element, x, y).click().perform()
        self.dormir()